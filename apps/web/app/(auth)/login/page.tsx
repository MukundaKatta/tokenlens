      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="space-y-4">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-card px-4 py-3 text-sm font-medium text-foreground hover:bg-accent transition-colors"
          >
